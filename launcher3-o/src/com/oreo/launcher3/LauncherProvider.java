...
import com.oreo.launcher3.AutoInstallsLayout.LayoutParserCallback;
import com.oreo.launcher3.LauncherSettings.Favorites;
import com.oreo.launcher3.LauncherSettings.WorkspaceScreens;
...
import com.oreo.launcher3.provider.RestoreDbTask;
import com.oreo.launcher3.util.ManagedProfileHeuristic;
import com.oreo.launcher3.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        private void addWorkspacesTable(SQLiteDatabase db, boolean optional) {
            // Always use IF NOT EXISTS to prevent crashes when the table already exists
            db.execSQL("CREATE TABLE IF NOT EXISTS " + WorkspaceScreens.TABLE_NAME + " (" +
