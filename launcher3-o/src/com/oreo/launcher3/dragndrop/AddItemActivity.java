...
package com.oreo.launcher3.dragndrop;
import com.oreo.launcher3.logging.LoggerUtils;
...
import com.oreo.launcher3.BaseActivity;
import com.oreo.launcher3.InstallShortcutReceiver;
import com.oreo.launcher3.InvariantDeviceProfile;
import com.oreo.launcher3.Launcher;
import com.oreo.launcher3.LauncherAppState;
import com.oreo.launcher3.LauncherAppWidgetProviderInfo;
...
import com.oreo.launcher3.widget.WidgetImageView;
...
public class AddItemActivity extends BaseActivity implements OnLongClickListener, OnTouchListener {
    ...
    private void logCommand(int command) {
        getUserEventDispatcher().dispatchUserEvent(LoggerUtils.newLauncherEvent(
                ...
                LoggerUtils.newContainerTarget(ContainerType.PINITEM)), null);
    }
}
