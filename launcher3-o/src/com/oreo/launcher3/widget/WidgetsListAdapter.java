...
import com.oreo.launcher3.WidgetPreviewLoader;
import com.oreo.launcher3.compat.AlphabeticIndexCompat;
import com.oreo.launcher3.model.PackageItemInfo;
import com.oreo.launcher3.model.WidgetItem;
import com.oreo.launcher3.util.LabelComparator;
...
public class WidgetsListAdapter extends Adapter<WidgetsRowViewHolder> {
            ...
            for (int i = childCount ; i < expectedChildCount; i++) {
                if ((i & 1) == 1) {
                    ...
                    WidgetCell widget = (WidgetCell) mLayoutInflater.inflate(
                            R.layout.launcher3o_widget_cell, row, false);
    ...
    public WidgetsRowViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewGroup container = (ViewGroup) mLayoutInflater.inflate(
                R.layout.launcher3o_widgets_list_row_view, parent, false);
