...
package com.oreo.launcher3.popup;
...
import com.oreo.launcher3.AbstractFloatingView;
import com.oreo.launcher3.BubbleTextView;
import com.oreo.launcher3.DragSource;
import com.oreo.launcher3.DropTarget;
import com.oreo.launcher3.ItemInfo;
import com.oreo.launcher3.Launcher;
import com.oreo.launcher3.LauncherAnimUtils;
import com.oreo.launcher3.LauncherModel;
import com.oreo.launcher3.LauncherSettings;
import com.oreo.launcher3.LogAccelerateInterpolator;
import com.oreo.launcher3.R;
import com.oreo.launcher3.Utilities;
import com.oreo.launcher3.accessibility.LauncherAccessibilityDelegate;
import com.oreo.launcher3.accessibility.ShortcutMenuAccessibilityDelegate;
import com.oreo.launcher3.anim.PropertyListBuilder;
import com.oreo.launcher3.anim.PropertyResetListener;
import com.oreo.launcher3.badge.BadgeInfo;
...
import com.oreo.launcher3.graphics.IconPalette;
import com.oreo.launcher3.graphics.TriangleShape;
import com.oreo.launcher3.notification.NotificationItemView;
import com.oreo.launcher3.notification.NotificationKeyData;
import com.oreo.launcher3.shortcuts.DeepShortcutManager;
import com.oreo.launcher3.shortcuts.DeepShortcutView;
import com.oreo.launcher3.shortcuts.ShortcutsItemView;
...
import static com.oreo.launcher3.userevent.LauncherLogProto.ContainerType;
import static com.oreo.launcher3.userevent.LauncherLogProto.ItemType;
import static com.oreo.launcher3.userevent.LauncherLogProto.Target;
...
public class PopupContainerWithArrow extends AbstractFloatingView implements DragSource,
    ...
    private void orientAboutIcon(BubbleTextView icon, int arrowHeight) {
        ...
        // Open above icon if there is room, or if we're in all apps view to avoid search bar
        int iconHeight = icon.getIcon().getBounds().height();
        int y = mTempRect.top + icon.getPaddingTop() - height;
        boolean isInAllApps = mLauncher.isAppsViewVisible();
        mIsAboveIcon = y > dragLayer.getTop() + insets.top || isInAllApps;
        if (!mIsAboveIcon) {
    ...
    public void fillInLogContainerData(View v, ItemInfo info, Target.Builder target, Target.Builder targetParent) {
        target.setItemType(ItemType.DEEPSHORTCUT);
        targetParent.setContainerType(ContainerType.DEEPSHORTCUTS);
    }
