...
import com.oreo.launcher3.DropTarget.DragObject;
import com.oreo.launcher3.LauncherSettings.Favorites;
import com.oreo.launcher3.accessibility.LauncherAccessibilityDelegate;
import com.oreo.launcher3.allapps.AllAppsContainerView;
import com.oreo.launcher3.allapps.AllAppsTransitionController;
import com.oreo.launcher3.allapps.DefaultAppSearchController;
import com.oreo.launcher3.anim.AnimationLayerSet;
import com.oreo.launcher3.compat.AppWidgetManagerCompat;
import com.oreo.launcher3.compat.LauncherAppsCompat;
import com.oreo.launcher3.compat.PinItemRequestCompat;
import com.oreo.launcher3.config.FeatureFlags;
import com.oreo.launcher3.config.ProviderConfig;
import com.oreo.launcher3.dragndrop.DragController;
import com.oreo.launcher3.dragndrop.DragLayer;
import com.oreo.launcher3.dragndrop.DragOptions;
import com.oreo.launcher3.dragndrop.DragView;
import com.oreo.launcher3.dragndrop.PinItemDragListener;
import com.oreo.launcher3.dynamicui.ExtractedColors;
import com.oreo.launcher3.folder.Folder;
import com.oreo.launcher3.folder.FolderIcon;
import com.oreo.launcher3.keyboard.CustomActionsPopup;
import com.oreo.launcher3.keyboard.ViewGroupFocusHelper;
import com.oreo.launcher3.logging.FileLog;
import com.oreo.launcher3.logging.UserEventDispatcher;
import com.oreo.launcher3.model.ModelWriter;
import com.oreo.launcher3.model.PackageItemInfo;
import com.oreo.launcher3.model.WidgetItem;
import com.oreo.launcher3.notification.NotificationListener;
import com.oreo.launcher3.pageindicators.PageIndicator;
import com.oreo.launcher3.popup.PopupContainerWithArrow;
import com.oreo.launcher3.popup.PopupDataProvider;
import com.oreo.launcher3.shortcuts.DeepShortcutManager;
import com.oreo.launcher3.shortcuts.ShortcutKey;
import com.oreo.launcher3.userevent.LauncherLogProto;
import com.oreo.launcher3.userevent.LauncherLogProto.Action;
import com.oreo.launcher3.userevent.LauncherLogProto.ContainerType;
import com.oreo.launcher3.userevent.LauncherLogProto.ControlType;
import com.oreo.launcher3.util.ActivityResultInfo;
import com.oreo.launcher3.util.ComponentKey;
import com.oreo.launcher3.util.ItemInfoMatcher;
import com.oreo.launcher3.util.MultiHashMap;
import com.oreo.launcher3.util.PackageManagerHelper;
import com.oreo.launcher3.util.PackageUserKey;
import com.oreo.launcher3.util.PendingRequestArgs;
import com.oreo.launcher3.util.TestingUtils;
import com.oreo.launcher3.util.Thunk;
import com.oreo.launcher3.util.ViewOnDrawExecutor;
import com.oreo.launcher3.widget.PendingAddShortcutInfo;
import com.oreo.launcher3.widget.PendingAddWidgetInfo;
import com.oreo.launcher3.widget.WidgetAddFlowHandler;
import com.oreo.launcher3.widget.WidgetHostViewLoader;
import com.oreo.launcher3.widget.WidgetsContainerView;
...
public class Launcher extends BaseActivity
    ...
    static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.oreo.launcher3.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    public static final int EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT = 100;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLauncherView = getLayoutInflater().inflate(R.layout.launcher3o_launcher, null);
    ...
    protected void onStop() {
        ...
        if (Utilities.ATLEAST_NOUGAT_MR1) {
            try {
                ...
                // Ignore framework NPE in AppWidgetServiceImpl on Android 13+
            }
        }
    ...
    public View createShortcut(ViewGroup parent, ShortcutInfo info) {
        BubbleTextView favorite = (BubbleTextView) getLayoutInflater().inflate(R.layout.launcher3o_app_icon,
                parent, false);
    ...
    FolderIcon addFolder(CellLayout layout, long container, final long screenId, int cellX,
        ...
        // Create the view
        FolderIcon newFolder = FolderIcon.fromXml(R.layout.launcher3o_folder_icon, this, layout, folderInfo);
    ...
    public void onBackPressed() {
        ...
        if (topView != null) {
            ...
            ued.logActionCommand(Action.Command.BACK.getNumber(), ContainerType.ALLAPPS);
            showWorkspace(true);
        } else if (isWidgetsViewVisible())  {
            ued.logActionCommand(Action.Command.BACK.getNumber(), ContainerType.WIDGETS);
            showOverviewMode(true);
        } else if (mWorkspace.isInOverviewMode()) {
            ued.logActionCommand(Action.Command.BACK.getNumber(), ContainerType.OVERVIEW);
            showWorkspace(true);
        } else {
            // TODO: Log this case.
            mWorkspace.exitWidgetResizeMode();
    ...
    private Intent buildThemeLaunchIntent(String theme) {
        ...
        switch (theme) {
            ...
            default:            cls = "com.oreo.launcher3.Launcher"; break;
        }
            ...
            if (!mWorkspace.isInOverviewMode()) {
                if (!mWorkspace.isTouchActive() && !ignoreLongPressToOverview) {
                    getUserEventDispatcher().logActionOnContainer(Action.Touch.LONGPRESS.getNumber(),
                            Action.Direction.NONE.getNumber(), ContainerType.WORKSPACE,
        ...
        if (!mDragController.isDragging()) {
            if (itemUnderLongClick == null) {
                ...
                if (mWorkspace.isInOverviewMode()) {
                    ...
                    getUserEventDispatcher().logActionOnContainer(Action.Touch.LONGPRESS.getNumber(),
                            Action.Direction.NONE.getNumber(), ContainerType.OVERVIEW);
                } else {
        ...
        for (int i = start; i < end; i++) {
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_FOLDER: {
                    view = FolderIcon.fromXml(R.layout.launcher3o_folder_icon, this,
    ...
    /**
     * $ adb shell dumpsys activity com.oreo.launcher3.Launcher [--all]
     */
    @Override
