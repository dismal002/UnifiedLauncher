...
import com.oreo.launcher3.Launcher.CustomContentCallbacks;
import com.oreo.launcher3.Launcher.LauncherOverlay;
import com.oreo.launcher3.UninstallDropTarget.DropTargetSource;
import com.oreo.launcher3.accessibility.AccessibleDragListenerAdapter;
import com.oreo.launcher3.accessibility.OverviewAccessibilityDelegate;
import com.oreo.launcher3.accessibility.OverviewScreenAccessibilityDelegate;
import com.oreo.launcher3.accessibility.WorkspaceAccessibilityHelper;
import com.oreo.launcher3.anim.AnimationLayerSet;
import com.oreo.launcher3.badge.FolderBadgeInfo;
...
import com.oreo.launcher3.dragndrop.SpringLoadedDragController;
import com.oreo.launcher3.folder.Folder;
import com.oreo.launcher3.folder.FolderIcon;
import com.oreo.launcher3.graphics.DragPreviewProvider;
import com.oreo.launcher3.graphics.PreloadIconDrawable;
import com.oreo.launcher3.popup.PopupContainerWithArrow;
import com.oreo.launcher3.shortcuts.ShortcutDragPreviewProvider;
...
import com.oreo.launcher3.util.LongArrayMap;
import com.oreo.launcher3.util.MultiStateAlphaController;
import com.oreo.launcher3.util.PackageUserKey;
import com.oreo.launcher3.util.Thunk;
import com.oreo.launcher3.util.VerticalFlingDetector;
import com.oreo.launcher3.util.WallpaperOffsetInterpolator;
...
public class Workspace extends PagedView
        ...
        if (qsb == null) {
            ...
            qsb = mLauncher.getLayoutInflater().inflate(
                    mLauncher.getDeviceProfile().isVerticalBarLayout()
                            ? R.layout.launcher3o_qsb_container : R.layout.launcher3o_qsb_blocker_view,
                    firstPage, false);
        }
    ...
    public CellLayout insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        CellLayout newScreen = (CellLayout) mLauncher.getLayoutInflater().inflate(
                        R.layout.launcher3o_workspace_screen, this, false /* attachToRoot */);
    ...
    public void createCustomContentContainer() {
        CellLayout customScreen = (CellLayout)
                mLauncher.getLayoutInflater().inflate(R.layout.launcher3o_workspace_screen, this, false);
   ...
   void mapPointFromChildToSelf(View v, float[] xy) {
    ...
    private void onDropExternal(final int[] touchXY, final CellLayout cellLayout, DragObject d) {
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                view = FolderIcon.fromXml(R.layout.launcher3o_folder_icon, mLauncher, cellLayout,
                        (FolderInfo) info);
                break;
            default:
    ...
    @Override
    public void fillInLogContainerData(View v, ItemInfo info, Target.Builder target, Target.Builder targetParent) {
        target.setGridX(info.cellX);
        target.setGridY(info.cellY);
        target.setPageIndex(getCurrentPage());
        targetParent.setContainerType(ContainerType.WORKSPACE);
        if (info.container == LauncherSettings.Favorites.CONTAINER_HOTSEAT) {
            target.setRank(info.rank);
            targetParent.setContainerType(ContainerType.HOTSEAT);
        } else if (info.container >= 0) {
            targetParent.setContainerType(ContainerType.FOLDER);
        }
    }
