...
import com.oreo.launcher3.LogDecelerateInterpolator;
...
import com.oreo.launcher3.pageindicators.PageIndicatorDots;
...
public class Folder extends AbstractFloatingView implements DragSource, View.OnClickListener,
    ...
    /**
     * Creates a new UserFolder, inflated from R.layout.launcher3o_user_folder.
     *
    ...
    static Folder fromXml(Launcher launcher) {
        return (Folder) launcher.getLayoutInflater().inflate(
                FeatureFlags.LAUNCHER3_DISABLE_ICON_NORMALIZATION
                        ? R.layout.launcher3o_user_folder : R.layout.launcher3o_user_folder_icon_normalized, null);
    }
    ...
    public void fillInLogContainerData(View v, ItemInfo info, Target.Builder target, Target.Builder targetParent) {
        ...
        target.setPageIndex(mContent.getCurrentPage());
