...
package com.oreo.launcher3.dynamicui;
    ...
    private Palette getHotseatPalette() {
        ...
        if (Utilities.ATLEAST_NOUGAT) {
            try (ParcelFileDescriptor fd = wallpaperManager
                ...
                Log.e(TAG, "Permission denied when accessing wallpaper file, using fallback method", e);
            }
        }
        ...
        try {
            ...
            Log.e(TAG, "Permission denied when accessing wallpaper drawable, using default colors", e);
            return null;
        }
    }
