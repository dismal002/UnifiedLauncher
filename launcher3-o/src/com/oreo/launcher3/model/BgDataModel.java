...
import com.oreo.launcher3.logging.DumpTargetWrapper;
...
import com.oreo.launcher3.model.LauncherDumpProto;
import com.oreo.launcher3.model.LauncherDumpProto.ContainerType;
import com.oreo.launcher3.model.LauncherDumpProto.DumpTarget;
import com.oreo.launcher3.model.LauncherDumpProto.ItemType;
...
public class BgDataModel {
    ...
    private synchronized void dumpProto(String prefix, FileDescriptor fd, PrintWriter writer,
        ...
        if (args.length > 1 && TextUtils.equals(args[1], "--debug")) {
            ...
            LauncherDumpProto.LauncherImpression proto = LauncherDumpProto.LauncherImpression.newBuilder().build();
            ...
            try {
                ...
                Log.d(TAG, proto.toByteArray().length + "Bytes");
            } catch (IOException e) {
