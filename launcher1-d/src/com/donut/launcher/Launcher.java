...
public final class Launcher extends Activity implements View.OnClickListener, OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.launcher1d_launcher);
        setupViews();
    ...
    private void setWallpaperDimension() {
        ...
        try {
            WallpaperManager.getInstance(this).suggestDesiredDimensions(
                    width * WALLPAPER_SCREENS_SPAN, height);
        } catch (Exception e) {
            // Ignore on devices that don't allow third-party wallpaper hints.
        }
    }
    ...
    protected void onResume() {
        ...
        if (mIsNewIntent) {
            ...
            mWorkspace.post(new Runnable() {
                public void run() {
                    try {
                        SearchManager searchManagerService = (SearchManager)
     ...
     *
     * @return A View inflated from R.layout.launcher1d_application.
     */
    View createShortcut(ApplicationInfo info) {
        return createShortcut(R.layout.launcher1d_application,
    ...
    void addFolder(boolean insertAtFirst) {
        ...
        // Create the view
        FolderIcon newFolder = FolderIcon.fromXml(R.layout.launcher1d_folder_icon, this,
    ...
    private void completeAddLiveFolder(Intent data, CellLayout.CellInfo cellInfo,
        ...
        if (!mRestoring) {
            ...
            final View view = LiveFolderIcon.fromXml(R.layout.launcher1d_live_folder_icon, this,
                (ViewGroup) mWorkspace.getChildAt(mWorkspace.getCurrentScreen()), info);
            mWorkspace.addInCurrentScreen(view, cellInfo.cellX, cellInfo.cellY, 1, 1, insertAtFirst);
        } else if (sModel.isDesktopLoaded()) {
            sModel.addDesktopItem(info);
    ...
    private void showNotifications() {
        // No public API exists for third-party launchers to expand notifications.
    }
    ...
    private void showDonutThemePicker() {
        ...
        final String current = getSharedPreferences(PREFS, MODE_PRIVATE).getString(KEY, "launcher2-j");
        int currentIndex = 0;
        ...
        new AlertDialog.Builder(this)
            ...
            .setSingleChoiceItems(displayNames, currentIndex, (dialog, which) -> {
                ...
                applyDonutAlias(selected);
                dialog.dismiss();
                startActivity(buildDonutLaunchIntent(selected));
            })
            .setNegativeButton("Cancel", null)
            .show();
    }

    private void applyDonutAlias(String theme) {
        android.content.pm.PackageManager pm = getPackageManager();
        String pkg = getPackageName();
        String[] aliases = {
            pkg + ".DonutHomeAlias",
            pkg + ".GingerbreadHomeAlias", pkg + ".JellyBeanHomeAlias",
            pkg + ".MarshmallowHomeAlias", pkg + ".OreoHomeAlias", pkg + ".HoneycombHomeAlias"
        };
        boolean[] enabled = {
            theme.equals("launcher1-d"),
            theme.equals("launcher2-g"), theme.equals("launcher2-j"),
    ...
    private Intent buildDonutLaunchIntent(String theme) {
        String pkg = getPackageName();
        String cls;
        switch (theme) {
    ...
    private void registerIntentReceivers() {
        if (sWallpaperReceiver == null) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 26) {
                application.registerReceiver(sWallpaperReceiver, filter, Context.RECEIVER_NOT_EXPORTED);
            } else {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 26) {
            registerReceiver(mApplicationsReceiver, filter, Context.RECEIVER_NOT_EXPORTED);
        } else {
        ...
        for ( ; i < end; i++) {
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_USER_FOLDER:
                    final FolderIcon newFolder = FolderIcon.fromXml(R.layout.launcher1d_folder_icon, this,
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_LIVE_FOLDER:
                    final FolderIcon newLiveFolder = LiveFolderIcon.fromXml(
                            R.layout.launcher1d_live_folder_icon, this,
                            (ViewGroup) workspace.getChildAt(workspace.getCurrentScreen()),
                            (LiveFolderInfo) item);
    ...
    private void loadWallpaper() {
        // Load the current device wallpaper and convert it into a bitmap.
        if (sWallpaper == null) {
            try {
                ...
                // READ_EXTERNAL_STORAGE not granted (Android 13+); skip wallpaper bitmap
                w(LOG_TAG, "Cannot load wallpaper bitmap: " + e.getMessage());
            }
        }
        if (sWallpaper != null) {
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.donut.launcher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
    ...
    private class RenameFolder {
        ...
        Dialog createDialog() {
            mWaitingForResult = true;
            final View layout = View.inflate(Launcher.this, R.layout.launcher1d_rename_folder, null);
    ...
    private static class WallpaperIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                w("Launcher", "Cannot load wallpaper bitmap: " + e.getMessage());
            }
    ...
    private class DrawerManager implements SlidingDrawer.OnDrawerOpenListener,
        ...
        public void onScrollEnded() {
            ...
            // Click-toggle can finish without a matching open/close callback on some builds.
            // Force final visibility based on the drawer's settled state.
            if (mDrawer.isOpened()) {
                mAllAppsGrid.setVisibility(View.VISIBLE);
            } else {
                mAllAppsGrid.setVisibility(View.INVISIBLE);
