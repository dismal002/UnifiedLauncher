...
public class Workspace extends ViewGroup implements DropTarget, DragSource, DragScroller {
    ...
    void addInScreen(View child, int screen, int x, int y, int spanX, int spanY, boolean insert) {
        if (screen < 0 || screen >= getChildCount()) {
            android.util.Log.w("DonutWorkspace", "Skipping item on screen " + screen + " (only " + getChildCount() + " screens)");
            return;
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mLauncher.isDrawerUp()) {
            ...
            canvas.clipOutRect(getScrollX(), top, getScrollX() + mDrawerContentWidth,
                    top + mDrawerContentHeight);
        }
    ...
    private void onDropExternal(int x, int y, Object dragInfo, CellLayout cellLayout,
        ...
        case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
            ...
            view = mLauncher.createShortcut(R.layout.launcher1d_application, cellLayout,
                    (ApplicationInfo) info);
            break;
        case LauncherSettings.Favorites.ITEM_TYPE_USER_FOLDER:
            view = FolderIcon.fromXml(R.layout.launcher1d_folder_icon, mLauncher,
