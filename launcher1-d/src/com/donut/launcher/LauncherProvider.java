...
import com.donut.launcher.LauncherSettings.Favorites;

public class LauncherProvider extends ContentProvider {
    private static final String LOG_TAG = "LauncherProvider";
    private static final boolean LOGD = true;

    private static final String DATABASE_NAME = "launcher_donut.db";
    
    private static final int DATABASE_VERSION = 4;

    static final String AUTHORITY = "com.donut.launcher.settings";
    
    static final String EXTRA_BIND_SOURCES = "com.donut.launcher.settings.bindsources";
    static final String EXTRA_BIND_TARGETS = "com.donut.launcher.settings.bindtargets";
