...
class LiveFolderAdapter extends CursorAdapter {
    ...
    LiveFolderAdapter(Launcher launcher, LiveFolderInfo info, Cursor cursor) {
        ...
        mIsList = info.displayMode == LiveFolderInfo.DISPLAY_MODE_LIST;
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        if (!mIsList) {
            view = mInflater.inflate(R.layout.launcher2g_application_boxed, parent, false);
        } else {
            view = mInflater.inflate(R.layout.launcher2g_application_list, parent, false);
