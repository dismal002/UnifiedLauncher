...
final class Utilities {
    ...
    private static void initStatics(Context context) {
        ...
        sGlowColorPressedPaint.setMaskFilter(new BlurMaskFilter(2 * density, BlurMaskFilter.Blur.SOLID));
        sGlowColorFocusedPaint.setColor(0xffff8e00);
        sGlowColorFocusedPaint.setMaskFilter(new BlurMaskFilter(2 * density, BlurMaskFilter.Blur.SOLID));
