...
public class UserFolder extends Folder implements DropTarget {
    ...
    /**
     * Creates a new UserFolder, inflated from R.layout.launcher2g_user_folder.
     *
    ...
    static UserFolder fromXml(Context context) {
        return (UserFolder) LayoutInflater.from(context).inflate(R.layout.launcher2g_user_folder, null);
    }
