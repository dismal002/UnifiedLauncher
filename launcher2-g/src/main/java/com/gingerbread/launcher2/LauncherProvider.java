...
// XmlUtils replaced with inline helper below
import com.gingerbread.launcher2.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    private static final String DATABASE_NAME = "launcher_gingerbread.db";
    
    private static final int DATABASE_VERSION = 8;

    static final String AUTHORITY = "com.gingerbread.launcher2.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w(TAG, "Downgrading DB from " + oldVersion + " to " + newVersion + " — wiping.");
                ...
                while (c != null && c.moveToNext()) {
                    ...
                    try {
                        ...
                        if (favoriteType == Favorites.ITEM_TYPE_WIDGET_CLOCK) {
                            // bindAppWidgetId removed in API 21; legacy widget migration skipped
        ...
        private int loadFavorites(SQLiteDatabase db) {
            ...
            try {
                ...
                // Inline replacement for XmlUtils.beginDocument (removed AOSP-internal dep)
                int eventType = parser.getEventType();
                while (eventType != XmlPullParser.START_TAG && eventType != XmlPullParser.END_DOCUMENT) {
                    eventType = parser.next();
                }
                if (eventType != XmlPullParser.START_TAG || !TAG_FAVORITES.equals(parser.getName())) {
                    throw new XmlPullParserException("No start tag found for: " + TAG_FAVORITES);
                }
        ...
        private boolean addAppWidget(SQLiteDatabase db, ContentValues values, ComponentName cn,
            ...
            try {
                ...
                // bindAppWidgetId(int, ComponentName) removed in API 21; skip legacy binding
            } catch (RuntimeException ex) {
                Log.e(TAG, "Problem allocating appWidgetId", ex);
            }
        ...
        private boolean addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            final int titleResId = a.getResourceId(R.styleable.Favorite_launcher_title, 0);
