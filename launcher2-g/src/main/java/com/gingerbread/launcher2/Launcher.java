...
import com.gingerbread.launcher2.R;
...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GingerState.getModel() == null) {
            LauncherApplication.initFromContext(this);
        }
        mModel = GingerState.getModel();
        mModel.initialize(this);
        mIconCache = GingerState.getIconCache();
        ...
        setContentView(R.layout.launcher2g_launcher);
        setupViews();
    ...
    */
     ...
     *
     * @return A View inflated from R.layout.launcher2g_application.
     */
    View createShortcut(ShortcutInfo info) {
        return createShortcut(R.layout.launcher2g_application,
    ...
    void addFolder() {
        ...
        // Create the view
        FolderIcon newFolder = FolderIcon.fromXml(R.layout.launcher2g_folder_icon, this,
    ...
    private void completeAddLiveFolder(Intent data, CellLayout.CellInfo cellInfo) {
        ...
        if (!mRestoring) {
            final View view = LiveFolderIcon.fromXml(R.layout.launcher2g_live_folder_icon, this,
                (ViewGroup) mWorkspace.getChildAt(mWorkspace.getCurrentScreen()), info);
            mWorkspace.addInCurrentScreen(view, cellInfo.cellX, cellInfo.cellY, 1, 1,
                    isWorkspaceLocked());
        }
    ...
    static LiveFolderInfo addLiveFolder(Context context, Intent data,
        ...
        Intent baseIntent = data.getParcelableExtra("android.intent.extra.liveFolders.BASE_INTENT");
        String name = data.getStringExtra("android.intent.extra.liveFolders.NAME");

        Drawable icon = null;
        Intent.ShortcutIconResource iconResource = null;

        Parcelable extra = data.getParcelableExtra("android.intent.extra.liveFolders.ICON");
        ...
        info.displayMode = data.getIntExtra("android.intent.extra.liveFolders.DISPLAY_MODE",
                LiveFolderInfo.DISPLAY_MODE_GRID);
    ...
    private void showNotifications() {
        // StatusBarManager.expand() is a restricted API on modern Android.
        // Use the EXPAND_STATUS_BAR permission + broadcast as a best-effort fallback.
        try {
            ...
            // Not available on all devices/versions — silently ignore.
        }
    }
    ...
    private void showThemePicker() {
        ...
        new android.app.AlertDialog.Builder(this)
            ...
            .setSingleChoiceItems(displayNames, currentIndex, (dialog, which) -> {
                ...
                applyGingerAlias(selected);
                dialog.dismiss();
                startActivity(buildGingerLaunchIntent(selected));
            })
            .setNegativeButton("Cancel", null)
            .show();
    }

    private void applyGingerAlias(String theme) {
        android.content.pm.PackageManager pm = getPackageManager();
        String pkg = getPackageName();
        String[] aliases = {
            pkg + ".DonutHomeAlias", pkg + ".GingerbreadHomeAlias",
            pkg + ".JellyBeanHomeAlias", pkg + ".MarshmallowHomeAlias", pkg + ".OreoHomeAlias", pkg + ".HoneycombHomeAlias"
        };
        boolean[] enabled = {
    ...
    private Intent buildGingerLaunchIntent(String theme) {
        String pkg = getPackageName();
        String cls;
        switch (theme) {
        ...
        return new Intent().setComponent(new android.content.ComponentName(pkg, cls))
...
//        }
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.gingerbread.launcher2.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
    ...
    private class RenameFolder {
        ...
        Dialog createDialog() {
            final View layout = View.inflate(Launcher.this, R.layout.launcher2g_rename_folder, null);
        ...
        for (int i=start; i<end; i++) {
            ...
            switch (item.itemType) {
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_USER_FOLDER:
                    final FolderIcon newFolder = FolderIcon.fromXml(R.layout.launcher2g_folder_icon, this,
                ...
                case LauncherSettings.Favorites.ITEM_TYPE_LIVE_FOLDER:
                    final FolderIcon newLiveFolder = LiveFolderIcon.fromXml(
                            R.layout.launcher2g_live_folder_icon, this,
                            (ViewGroup) workspace.getChildAt(workspace.getCurrentScreen()),
                            (LiveFolderInfo) item);
