...
class ApplicationInfo extends ItemInfo {
    ...
    public ApplicationInfo(PackageManager pm, ResolveInfo info, IconCache iconCache) {
        ...
        try {
            ...
            Log.d("Launcher2.ApplicationInfo", "PackageManager.getApplicationInfo failed for " + packageName);
        }
    ...
    public static void dumpApplicationInfoList(String tag, String label, ArrayList<ApplicationInfo> list) {
        ...
        while (it.hasNext()) {
            ...
            Log.d(tag, "   title=\"" + info.title + "\" titleBitmap=" + info.titleBitmap + " iconBitmap=" + info.iconBitmap + " firstInstallTime=" + info.firstInstallTime);
        }
    }
