...
import com.jellybean.launcher2.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.jellybean.launcher2.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onDowngrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            // Device has a newer DB (from a previous install). Drop and recreate.
            Log.w(TAG, "onDowngrade from " + oldVersion + " to " + newVersion + ": recreating DB");
            db.execSQL("DROP TABLE IF EXISTS " + TABLE_FAVORITES);
            onCreate(db);
        }
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        String title;
                        int titleResId =  a.getResourceId(R.styleable.Favorite_itemTitle, -1);
                        if (titleResId != -1) {
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            final int titleResId = a.getResourceId(R.styleable.Favorite_itemTitle, 0);
