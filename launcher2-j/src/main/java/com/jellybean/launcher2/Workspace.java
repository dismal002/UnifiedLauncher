...
import com.jellybean.launcher2.FolderIcon.FolderRingAnimator;
...
public class Workspace extends SmoothPagedView
    ...
    */
    ...
    void addApplicationShortcut(ShortcutInfo info, CellLayout target, long container, int screen,
        ...
        View view = mLauncher.createShortcut(R.layout.launcher2j_application, target, (ShortcutInfo) info);
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            case LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT:
                ...
                view = mLauncher.createShortcut(R.layout.launcher2j_application, cellLayout,
                        (ShortcutInfo) info);
                break;
            case LauncherSettings.Favorites.ITEM_TYPE_FOLDER:
                view = FolderIcon.fromXml(R.layout.launcher2j_folder_icon, mLauncher, cellLayout,
