...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    /**
     * Creates a new UserFolder, inflated from R.layout.launcher2j_user_folder.
     *
     * @param context The application's context.
     *
    ...
    static Folder fromXml(Context context) {
        return (Folder) LayoutInflater.from(context).inflate(R.layout.launcher2j_user_folder, null);
    }
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        final TextView textView =
            (TextView) mInflater.inflate(R.layout.launcher2j_application, this, false);
            ...
            public void run() {
               ...
               View child = null;
                ...
                if (getItemCount() == 1) {
                    ...
                    child = mLauncher.createShortcut(R.layout.launcher2j_application, cellLayout,
                            finalItem);
