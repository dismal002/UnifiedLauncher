...
import com.marshmallow.launcher.Workspace.State;
...
public class QsbBlockerView extends View implements Workspace.OnStateChangeListener {
    ...
    protected void onAttachedToWindow() {
        ...
        Workspace w = ((Launcher) getContext()).getWorkspace();
    ...
    public void prepareStateChange(State toState, AnimatorSet targetAnim) {
        ...
        if (targetAnim == null) {
            ...
            ObjectAnimator anim = ObjectAnimator.ofInt(mBgPaint, "alpha", finalAlpha);
