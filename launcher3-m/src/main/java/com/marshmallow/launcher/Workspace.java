...
import com.marshmallow.launcher.FolderIcon.FolderRingAnimator;
import com.marshmallow.launcher.Launcher.CustomContentCallbacks;
import com.marshmallow.launcher.Launcher.LauncherOverlay;
import com.marshmallow.launcher.LauncherSettings.Favorites;
import com.marshmallow.launcher.UninstallDropTarget.UninstallSource;
import com.marshmallow.launcher.accessibility.LauncherAccessibilityDelegate;
import com.marshmallow.launcher.accessibility.LauncherAccessibilityDelegate.AccessibilityDragSource;
import com.marshmallow.launcher.accessibility.OverviewScreenAccessibilityDelegate;
import com.marshmallow.launcher.accessibility.WorkspaceAccessibilityHelper;
...
import com.marshmallow.launcher.util.WallpaperUtils;
import com.marshmallow.launcher.widget.PendingAddShortcutInfo;
    ...
    */
    ...
    public Animator setStateWithAnimation(State toState, int toPage, boolean animated,
        ...
        if (mOnStateChangeListener != null) {
            mOnStateChangeListener.prepareStateChange(toState, (workspaceAnim instanceof AnimatorSet)
                    ? (AnimatorSet) workspaceAnim : null);
        }
